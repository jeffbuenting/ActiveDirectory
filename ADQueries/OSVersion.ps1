...
$Servers = Get-ADComputer -Filter { Enabled -eq "True" -and OperatingSystem -like "Windows Server*"} -Properties Name, OperatingSystem, SamAccountName, DistinguishedName, LastLogonDate, LastLogonTimeStamp 

$Servers | Sort-Object OperatingSystem | Format-Table DNSHostName, OperatingSystem,  @{N='LastLogon';E={[DateTime]::FromFileTimeUtc($_.LastLogonTimeStamp)}},Enabled,Distinguishedname
